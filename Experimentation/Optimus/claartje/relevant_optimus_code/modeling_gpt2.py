...
class Attention(nn.Module):
    ...
    def forward(self, x, layer_past=None, attention_mask=None, head_mask=None, head_i=None):
        x = self.c_attn(x) # make a matrix that holds q, k , v ! FOR THE WORDS OUTPUTTED SO FAR !!
        # if head_i is not None:
        #     if head_i == 0:
        #         print("GPT2 | attention forward | XX x.shape", x.shape)
        query, key, value = x.split(self.split_size, dim=2)
        # if head_i is not None:
        #     if head_i == 0:
        #         print("GPT2 | attention forward | ZZ key.shape", key.shape)
        #         print("GPT2 | attention forward | ZZ query.shape", query.shape)
        #         print("GPT2 | attention forward | ZZ value.shape", value.shape)
        ...
        if layer_past is not None:
            ...
            # if head_i is not None:
            #     if head_i == 0:
            #         print("GPT2 | attention forward | XX past_key concat key shapes resp.:", past_key.shape, key.shape)
        ...
        # if head_i is not None:
        #     if head_i == 0:
        #         print("GPT2 | attention forward | XX query.shape", query.shape)
        #         print("GPT2 | attention forward | XX key.shape", key.shape)
        #         print("GPT2 | attention forward | XX value.shape", value.shape)

        attn_outputs = self._attn(query, key, value, attention_mask, head_mask)

        # if head_i is not None:
        #     if head_i == 0:
        #         print("GPT2 | attention forward | XX len(attn_outputs)", len(attn_outputs))
        ...
        # if head_i is not None:
        #     if head_i == 0:
        #         print("GPT2 | attention forward | XX a after merge heads.shape", a.shape)

        a = self.c_proj(a)

        # if head_i is not None:
        #     if head_i == 0:
        #         print("GPT2 | attention forward | XX a after c_proj .shape", a.shape)
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(self, input_ids, past=None, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None,
        ...
        if position_ids is None:
            ...
            # print("GPT2 | position_ids", position_ids)
