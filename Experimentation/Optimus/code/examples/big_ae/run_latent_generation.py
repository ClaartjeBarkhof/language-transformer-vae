...
def latent_code_from_text(text, tokenizer_encoder, model_vae, args):
    ...
    with torch.no_grad():
        ...
        all, pooled_hidden_fea = model_vae.encoder(x0, attention_mask=(x0 > 0).float())  #
...
def interpolate(model_vae, tokenizer_encoder, tokenizer_decoder, args):
    ...
    print("*"*40)
    print("args.sent_source:", args.sent_source)
    print("args.sent_target:", args.sent_target)
    print("*"*40)
...
def main(jupyter=False):
    ...
    train_data_file = '/Users/claartje/Dropbox (Persoonlijk)/Studie/Master AI/Thesis/Thesis_MSc_AI/Experimentation/Optimus/data/datasets/debug_data/train.txt'
    test_data_file = '/Users/claartje/Dropbox (Persoonlijk)/Studie/Master AI/Thesis/Thesis_MSc_AI/Experimentation/Optimus/data/datasets/debug_data/test.txt'
    checkpoint_dir = '/Users/claartje/Dropbox (Persoonlijk)/Studie/Master AI/Thesis/Thesis_MSc_AI/Experimentation/Optimus/output/LM/Snli/768/philly_vae_snli_b1.0_d5_r00.5_ra0.25_length_weighted/checkpoint-31250/'
